...
export default function DataEntryPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    newHabitData.sort((a, b) => new Date(a.date).getTime() - new Date(b.date).getTime())
        ...
        <div className="flex h-full flex-col">
          ...
          <nav className="flex-1 overflow-y-auto">
            <ul className="p-4 space-y-2">
              ...
              <li>
                <a href="#" className="block px-4 py-2 rounded-md hover:bg-gray-100">Analytics</a>
              </li>
              <li>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => setFormData(prev => ({ ...prev, teethBrushed: checked as boolean }))}
                  />
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => setFormData(prev => ({ ...prev, workedOut: checked as boolean }))}
                  />
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => setFormData(prev => ({ ...prev, pictureTaken: checked as boolean }))}
                  />
                ...
                {formData.image && (
                  <div>
                    <img src={formData.image} alt="Uploaded" className="max-w-full h-auto" />
                  </div>
                )}
                <div>
                  <Label>Review</Label>
                  <div className="space-y-2">
                    {['overall', 'energy', 'mood', 'productivity'].map((category) => (
                        ...
                        <div className="flex">
                          {[1, 2, 3, 4, 5].map((value) => (
                            <button
                              ...
                              className={`text-2xl ${value <= formData.review[category as keyof typeof formData.review] ? 'text-yellow-500' : 'text-gray-300'}`}
                            >
                              ★
                            </button>
                          ))}
